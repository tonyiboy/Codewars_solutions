...
// guessing a color, and then pulling one marble out. You get a point if you guessed correctly. The trick is you
...
function guessBlue(blueStart, redStart, bluePulled, redPulled) {
    const sum = blueStart + redStart - (bluePulled + redPulled);
    return (blueStart - bluePulled) / sum;
  }