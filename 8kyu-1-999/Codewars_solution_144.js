...
function shuffleIt(arr, ...indices) {
    const swapedArray = [...arr];
    const map = indices.map(
      (indicesToSwap) =>
        ([swapedArray[indicesToSwap[1]], swapedArray[indicesToSwap[0]]] = [
          swapedArray[indicesToSwap[0]],
          swapedArray[indicesToSwap[1]],
        ])
    );
