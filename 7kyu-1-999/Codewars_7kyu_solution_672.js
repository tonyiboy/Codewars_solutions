...
// you need to return the other complementary side. DNA strand is never empty or there is no DNA at 
...
function dnaStrand(dna){
    ...
    dna[i] === "A" ? result += "T" : dna[i] === "T" ? result += "A" : dna[i] === "C" ? result += "G" : result += "C"
