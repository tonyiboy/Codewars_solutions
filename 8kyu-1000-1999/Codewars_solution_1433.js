...
function isLockNessMonster(s) {
    ...
    let result = s.toLowerCase().includes("3.50")
    let resultTwo = s.toLowerCase().includes("three fifty")
    let resultThree = s.toLowerCase().includes("tree fiddy")
    
    if(result === true || resultTwo === true || resultThree === true){
      return true 
    }else return false
  }