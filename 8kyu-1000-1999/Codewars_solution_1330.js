...
// The input is the amount of USD as an integer, and the output should be a string that states the amount of Yuan followed
//  by 'Chinese Yuan'
...
let usdcny = usd => `${(usd * conversion ).toFixed(2)} Chinese Yuan`