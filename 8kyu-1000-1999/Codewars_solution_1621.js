...
// But there is a guideline that will help a beginning vaulter start at approximately 
// the right location for the so-called "three-step approach," based on the vaulter's body height.
...
// (If you're not clear on that, search online for "linear equation.") But there is also a constant offset involved. 
...
function startingMark(bodyHeight){
    ...
    let mark = (10.67 - 9.45) / (1.83 - 1.52)
    return Math.round((10.67 + mark * bodyHeight - mark * 1.83) * 100) / 100
  }